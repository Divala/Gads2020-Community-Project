...
class SecondVisitRecordsActivity : AppCompatActivity(), SecondVisitRecordsView {
    private lateinit var presenter: SecondVisitRecordsPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = SecondVisitRecordsPresenter(
            this,
            this,
    ...
    override fun showMessage(s: String) {
        ...
        AlertDialog.Builder(this).setTitle("Success").setMessage(s)
